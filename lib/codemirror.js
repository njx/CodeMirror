  ...
  function CodeMirror(place, givenOptions) {
    ...
    function updateScroll(updateSize) {
      ...
      if (updateSize && scroller.clientHeight) {
        ...
        // actual code is shorter than the lineSpace width, just use that, so we can avoid unnecessarily
        // showing scrollbars.
        code.style.width = (lineSpaceX() + Math.min(lineSpace.offsetWidth, stringWidth(maxLine) + 2)) + "px";
