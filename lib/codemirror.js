...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    // TODO: should we rename "code" to "scrollerInner" or some such, since that's really its role now?
    ...
    function updateScroll() {
      ...
      if (scroller.clientHeight) {
        // The code div sets the virtual scroll area. It has to span from the left edge of the scroller
        // to where the right edge of the lineSpace would be if it weren't scrolled, plus a pixel
        // to account for the fact that the cursor might be at that edge.
        code.style.width = Math.floor(lineSpaceX() + lineSpace.offsetWidth + 1) + "px";
    ...
    function updateDisplay(changes, suppressCallback) {
      ...
      function checkHeights() {
        ...
        // TODO: no longer seems necessary now that updateScroll() always updates the code height.
//        if (heightChanged)
//          code.style.height = (doc.height * th + 2 * paddingTop()) + "px";
      ...
      if (options.lineWrapping) {
        ...
        if (maxWidth > scroller.clientWidth) {
          ...
          // TODO: this won't work now that the code div is responsible for setting the width of the
          // virtual scroll area. Is it still necessary?
//          code.style.width = "";
//          code.style.width = scroller.scrollWidth + "px";
        } else {
          // TODO: Now that the lineSpace is no longer a child of the scroller, we need to force its
          // width in this case so it takes up the whole width (otherwise the selection is drawn only
          // to the end of the longest line). Does this seem right?
          // The code.style.width will be updated in updateScroll().
          lineSpace.style.width = Math.floor(scroller.clientWidth - lineSpaceX()) + "px";
        }
      }
