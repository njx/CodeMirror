...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    if (options.flickerFix) {
      ...
      if (/MSIE [1-8]\b/.test(navigator.userAgent)) scrollbar.className += " cm-sb-ie";
    }
    ...
    var shiftSelecting, lastClick, lastDoubleClick, lastScrollTop = 0, lastScrolleft = 0, draggingText,
  ...
  CodeMirror.defaults = {
    ...
    tabindex: null,
    autofocus: null,
    flickerFix: !/Firefox/.test(navigator.userAgent)
  };
