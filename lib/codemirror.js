  ...
  function CodeMirror(place, givenOptions) {
    ...
    function updateScroll() {
      ...
      if (scroller.clientHeight) {
        ...
        // to where the right edge of the lineSpace would be if it weren't scrolled.
        code.style.width = Math.floor(lineSpaceX() + lineSpace.offsetWidth) + "px";
        code.style.height = doc.height * th + 2 * paddingTop() + "px";
        wrapper.style.height = scroller.height + "px";
      }
